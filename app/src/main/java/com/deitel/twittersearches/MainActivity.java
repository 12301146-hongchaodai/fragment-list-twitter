...
public class MainActivity extends Activity implements fragment_1st.OnFragmentInteractionListener
{
 //name of SharedPreferences XML file that stores the saved searches
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ft.add(R.id.fridLayout, new fragment_1st());
   ...
   OnItemClickListener itemClickListener = new OnItemClickListener()
   {
    ...
    public void onFragmentInteraction(String url, String tag) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.replace(R.id.fridLayout, fragment_2nd.newInstance(url,tag));                            //****************************************************8//
        ft.addToBackStack(null);
        ft.commit();
    }
